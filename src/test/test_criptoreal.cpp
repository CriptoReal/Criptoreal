...
#define BOOST_TEST_MODULE Criptoreal Test Suite

#include "test_criptoreal.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_criptoreal_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
