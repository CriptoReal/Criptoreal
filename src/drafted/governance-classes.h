 ...
 *
 *   // network
 *   CCriptorealNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.criptoreal.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCriptorealNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCriptorealNetwork(UniValue objIn)
    {
...
// // can be under: CriptorealNetwork
// //   -- signature requirements : Key1(User)
// class CCriptorealNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CriptorealNetwork);
//     // }
