...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CriptorealNetwork") type = CriptorealNetwork;
    if(strType == "CriptorealNetworkVariable") type = CriptorealNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CriptorealNetwork) s = "CriptorealNetwork";
    if(type == CriptorealNetworkVariable) s = "CriptorealNetworkVariable";
