...
2. run criptoreald with -printalert or -sendalert like this:
   /path/to/criptoreald -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.criptoreal.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Criptoreal Core:0.12.0.58/"));
