    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Criptoreal Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Criptoreal Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  criptoreal-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Criptoreal in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CRS, 0.1 CRS, 1 CRS and 10 CRS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://criptoreal.atlassian.net/wiki/display/DOC/PrivateSend\">https://criptoreal.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Criptoreal Core is shutting down...") + "<br /><br />" +
