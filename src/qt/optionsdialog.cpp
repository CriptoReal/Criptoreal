    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CRS-light"), QVariant("light"));
    ui->theme->addItem(QString("CRS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CRS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CRS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CRS-traditional"), QVariant("trad"));
