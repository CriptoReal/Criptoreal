...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Criptoreal Core criptoreal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  criptoreal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded criptoreal transaction") + "\n" +
              "  criptoreal-tx [options] -create [commands]   " + _("Create hex-encoded criptoreal transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded criptoreal transaction
