...
Example: ```mngovernance submit cool-project http://www.cool-project/one.json 12 100000 C6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7 1200 464a0eb70ea91c94295214df48c47baa72b3876cfb658744aaf863c7b5bf1ff0```
...
```
{
    ...
    "PaymentAddress" : "C6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7",
    "Ratio" : 0.00000000,
    "Yeas" : 0,
    "Nays" : 0,
    "Abstains" : 0,
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` CRS to ```C6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
