...
- Added new units: `reals` (1 / 100.000.000 CRS)
- Added units for testnet: tDRK, mtDRK, utDRK, treals
...
- Reduced lower darksend limit to 1.5 CRS
- Fixed progress bar calculation for low amounts
- Improved support for adding CRS after anon has completed
...
- Add '-disablewallet' mode to let criptoreald run entirely without wallet (when
  built with wallet)
- Update default '-rpcsslciphers' to include TLSv1.2
- make '-logtimestamps' default on and rework help-message
- RPC client option: '-rpcwait', to wait for server start
- Remove '-logtodebugger'
- Allow `-noserver` with criptoreald
