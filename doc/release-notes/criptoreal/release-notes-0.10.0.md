...
- Darksend tested with 2.5 CRS successfully and I've set that as the minimum
...
- Fixed issue with denominating small amounts of CRS in large wallet
  (http://jira.darkcoin.qa/browse/CRS-46)
- Made splitting up initial inputs much more efficient. Now when splitting up,
  it will use powers of two from 4096 CRS in reverse to get the best possible
...
- Fixed issue with completed amount jumping around
  (http://jira.darkcoin.qa/browse/CRS-46)
- Made messages less threatening (http://jira.darkcoin.qa/browse/CRS-60)
...
- RPC calls are changed a bit:
    ...
    darksend Xaddr 100 - Will send 100 denominated CRS to Xaddr
    sendtoaddress Xaddr 100 - Will send 100 non-denominated CRS to Xaddr
...
/darkcoin-qt -datadir=/home/user/.darkcoin -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:15511"
/darkcoin-qt -datadir=/home/user/.darkcoin2 -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:15511"

and even disable darksend auto-denom if wanted:
/darkcoin-qt -datadir=/home/user/.darkcoin -listen=0 -darksendrounds=8 -usemasternode="192.168.56.102:15511" -disabledarksend=1


0.10.12.7 Release notes
-----------------------

- Added a smart input splitting method. Place 1000+CRS into a brand new wallet
